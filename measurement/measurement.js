...
/**
 * measure: overhead generated by each message publishing by a client
 * overhead = allLengthOf(connect) + allLengthOf(connack) +
 * allLengthOf(publish) - messageLengthOf(publish)
 *
 * unit: byte
 *
...
(function () {
    ...
    var i,
        ...
        topic = 'test0', // topic size at 5 byte
        message,
        messageLength,
        messageLengthInByte,
